        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-0.5">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="relative px-4 py-2 text-sm text-gray-200 hover:text-white cursor-pointer transition-colors duration-200 group font-medium"
                >
                  {link.label}
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                className="md:hidden p-2 text-gray-300 hover:text-white transition-colors font-semibold"
